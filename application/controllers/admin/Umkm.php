...
class Umkm extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if (intval($sess['id_role']) == 2) {
            $where = array();
            $where['desa_umkm.id_desa'] = $sess['id_desa'];
        ...
        $crud->required_fields('id_desa','nama_umkm','foto1');
    ...
    public function is_uniqe_nourut($str)
    {
        ...
        $this->db->where('id_umkm <>', $primary_key);
        $db = $this->db->get('desa_umkm');
...
*/
    ...
    function _callback_before_insert($post_array)
    {
        ...
        $post_array['no_urut'] = get_increment('desa_umkm', 'no_urut');
