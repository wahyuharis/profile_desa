<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    $config['grocery_crud_date_format'] = 'dd/mm/yyyy';
    ...
    $config['grocery_crud_file_upload_max_file_size'] = '80MB'; //eg. '10MB' (Mega Bytes), '1067KB' (Kilo Bytes), '5000B' (Bytes)
    ...
    $config['grocery_crud_paging_options'] = array('5','10','25','50','100','1000');
